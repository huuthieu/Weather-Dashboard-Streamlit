...
from models.models import convert_label
...
st.write("""This demo will visualize the data of each province. Enjoy!""")
...
with col2:
    option2 = st.selectbox("Choose province", tuple(["All"] + list_provinces))

with col3:
    option3 = st.selectbox("Choose feature", tuple(list_features))
...
genre = st.radio("Visualization in", options=("Annualy", "Monthly"))
...
genre = st.radio("Type of visualization", ("Monthly", "Daily"))
...
genre1 = st.radio("Choose type of visualization", ("Monthly", "Daily"))
...
fig.update_layout(
    width=800, font=dict(family="Courier New, monospace", size=18)
)
